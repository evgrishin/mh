...
{if $product->description}
	...
	<section class="page-product-box">
		...
		{if isset($product) && $product->description}
			<!-- full description -->
			<div  class="rte">{Meta::replaceForCEOWord($product->description)}
                {hook h='displayProductDescriptionAdd' product=$accessory}</div>
		{/if}
	</section>
	<!--end  More info -->
{/if}
				...
				<div class="product_list grid row">
					{foreach from=$accessories item=accessory name=accessories_list}
						{if ($accessory.allow_oosp || $accessory.quantity_all_versions > 0 || $accessory.quantity > 0) && $accessory.available_for_order && !isset($restricted_country_mode)}
							...
							<div class="product-container no-padding col-xs-12 col-sm-6 col-md-3 col-lg-3 text-center product-block">
								<div class="left-block">
									...
									<div class="content-buttons clearfix">
										...
										<div class="btn-small">		
											<a class="btn quick-view" href="{$accessory.link|escape:'html':'UTF-8'}" title="{l s='Quick view'}" >
												<i class="fa fa-eye"></i>
											</a>
										</div>
										{/if}
								...
								<div class="right-block">	
									<div class="product-meta">		
										<div class="product-title">	
											<h5 class="name">
												<a href="{$accessoryLink|escape:'html':'UTF-8'}" title="{$accessory.name|escape:'html':'UTF-8'}">
