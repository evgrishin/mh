...
{if isset($p) AND $p}
	...
	<!-- Pagination -->
	<div>
		<div id="pagination{if isset($paginationId)}_{$paginationId}{/if}" class="pagination col-md-12">
		...
		{/if}
			<div id="show_more" class="col-md-12">
				<div>
                    {if $start!=$stop}
                        {if $pages_nb > 1 AND $p != $pages_nb}
							<input type="button" id="pageadd" class="pageadd" title="{l s='Show'}" value="{l s='Show'}"
								   style="clear: both;">
                        {/if}
                    {/if}
				</div>
