			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="phone_mobile" id="phone_mobile" required  placeholder="(___) ___ __ __" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
						</div>
					</div>
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation">
				...
				<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
					<label class="control-label col-sm-4" for="phone_mobile">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
					<div class="col-sm-6">
						<input type="text" class="form-control" name="phone_mobile" required  placeholder="(___) ___ __ __" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
					</div>
				</div>
