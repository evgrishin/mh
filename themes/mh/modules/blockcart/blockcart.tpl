...
{if ($delivery_tk == '32')}
{addJsDefL name=freeShippingTranslation}{l s='by TK!' mod='onepagecheckout' js=1}{/addJsDefL}
{addJsDefL name=freeProductTranslation}{l s='by TK!' mod='onepagecheckout' js=1}{/addJsDefL}
{else}
