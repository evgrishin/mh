...
<head>{hook h='displayStartHeader'}
<meta charset="utf-8" />
{if ($url_product != '')}
<meta property="og:locale" content="ru_RU" />
<meta property="og:type" content="website" />
<meta property="og:site_name" content="{$sitename|escape:'html':'UTF-8'}" />
<meta property="og:url" content="{$url_product}" />
					    	...
					    	{if $scenes || $category->description || $category->id_image}
								<div class="content_scene_cat">
									...
									<div class="content_scene_cat_bg scene_cat">
										...
										{else}{hook h='displayCategoryImage'}
										{/if}
									 </div>
									{/if}
					            </div>
