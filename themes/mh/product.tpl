...
{if $errors|@count == 0}
	...
	<div class="primary_block" itemscope itemtype="http://schema.org/Product">
			...
			<div id="image-block" class="clearfix">
				<div class="p-label">
                    ...
                    {if $product->condition == 'gift'}
						<div tabindex="0" id="special-label-{$product->id|intval}" class="special-label-{$product->id|intval} focus-off " data-toggle="popover" data-html="true" data-container="body" data-content="" style="position: absolute;top: 2px;left: 2px;width:87px;height:87px;background-image: url(../img/5.png);"></div>
                    {/if}
						...
						{if isset($images)}
							{foreach from=$images item=image name=thumbnails}
								...
								<li id="thumbnail_{$image.id_image}"{if $smarty.foreach.thumbnails.last} class="last"{/if}>
									<a itemscope itemtype="http://schema.org/ImageObject" {if $jqZoomEnabled && $have_image && !$content_only} href="javascript:void(0);" rel="{literal}{{/literal}gallery: 'gal1', smallimage: '{$link->getImageLink($product->link_rewrite, $imageIds, 'large_default')|escape:'html':'UTF-8'}',largeimage: '{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}'{literal}}{/literal}"{else} href="{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}"	data-fancybox-group="other-views" class="fancybox{if $image.id_image == $cover.id_image} shown{/if}"{/if} title="{$imageTitle}">
										<img class="img-responsive" id="thumb_{$image.id_image}" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'cart_default')|escape:'html':'UTF-8'}" alt="{$imageTitle}" title="{$imageTitle}" height="{$cartSize.height}" width="{$cartSize.width}" />
										<img style="display:none" src="{$link->getImageLink($product->link_rewrite, $imageIds, 'thickbox_default')|escape:'html':'UTF-8'}" alt="{$imageTitle}" itemprop="contentUrl" />
										<meta itemprop="caption" content="{$product->name}"/>
										<meta itemprop="description" content="{$imageTitle} - {$product->manufacturer_name}"/>
									</a>
								</li>
							{/foreach}
						{/if}
		...
		<div class="pb-center-column col-xs-12 col-sm-12 col-md-5">
			...
			<p>
				<label>{l s='kod tovara'}</label><span class="editable">{$product->reference}</span>
			</p>
			{/if}
			...
			{if $product->description_short || $packItems|@count > 0}
				<div id="short_description_block">
                    ...
                    {if isset($myfeatures) && $myfeatures}
                        {$features_count = 0}
                        <div class="product-features">
                            {foreach from=$myfeatures item=feature}
                                {if $feature.show_in_text > 0}
        ...
        <div class="clearfix row">
            <div class="">
				...
				<div class="form-group selector1">
						...
						<input class="form-control grey" type="phone" placeholder="+7___ ___ __ __" name="ophone" id="ophone" value="">
				</div>
