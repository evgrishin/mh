			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" name="phone_mobile" required  placeholder="+7(___) ___ __ __"  id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
						</div>
					</div>
