...
<script type="text/javascript">
	...
	{if ($delivery_tk == '32')}
    var freeShippingTranslation = "{l s='by TK!' mod='onepagecheckout'}";
    var freeProductTranslation = "{l s='by TK!' mod='onepagecheckout'}";
	{else}
    ...
    <div id="shipping-payment-block" class="clearfix pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6"> {* closing div in order-payment *}
...
$(document).ready(function(){
	...
	$("#phone_mobile").attr("placeholder", "+7___ ___ __ __");
});
</script>