...
{capture name=delivery_address_block}
    ...
    <fieldset id="opc_delivery_address" style="display: {if (isset($guestInformations) && $guestInformations.use_another_invoice_address) OR (!isset($guestInformations) && $def_different_billing == 1) OR !$invoice_first}block{else}none{/if}">
        ...
        <div class="address-type-header delivery" style="display: none;">{l s='Delivery address' mod='onepagecheckout'}
      ...
      <div class="address_fields">
        ...
        <p class="required text" {if $isVirtualCart && $opc_config.virtual_no_delivery}{/if}style="display: none;">
        ...
        <p class="required text" {if !isset($opc_config.phone_mobile_delivery) || !$opc_config.phone_mobile_delivery}style="display: none;"{/if}>
            ...
            <input type="text" required  placeholder="+7(___) ___ __ __" class="text" name="phone_mobile" id="phone_mobile"
...
<div id="opc_new_account" class="opc-main-block clearfix pull-left col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
<div id="opc_new_account-overlay" class="opc-overlay" style="display: none;"></div>

{$smarty.capture.login_block}

<div id="opc_account_form" class="opc-main-block clearfix pull-left">
