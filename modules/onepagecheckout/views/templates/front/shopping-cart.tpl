...
<script type="text/javascript">
    ...
    var txtFreePrice = "11{l s='Free!' mod='onepagecheckout'}";
...
{if $total_shipping_tax_exc <= 0 && !isset($virtualCart)}
    <tr class="cart_total_delivery summary-line">
        ...
        <td class="price" id="total_shipping"> {if ($delivery_tk == '32')} {l s='by TK!' mod='onepagecheckout'} {else} {l s='Free Shipping!' mod='onepagecheckout'}{/if} </td>
    </tr>
{else}
    {if $use_taxes}
        {if $priceDisplay}
