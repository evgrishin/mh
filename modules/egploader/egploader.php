        ...
        return '<script>
				...
				$(document).ready(function() {
                    ...
                    $("#create_product").click(function() {
                        $("input:checkbox:checked").map(function() {
                            download("createproduct", $(this).val(), $(this).val(), "AdminEGPLOADER", admin_ploader_ajax_url, 0);
                        }).get();
                     });
                    
                    $("#update_category").click(function() {
                         $("input:checkbox:checked").map(function() {
                             download("updatecategory", $("#id_category_selected").val(), $(this).val(), "AdminEGPLOADER", admin_ploader_ajax_url, 0);
                          }).get();
                     });
                    
                    $("#update_manufacturer").click(function() {
                         $("input:checkbox:checked").map(function() {
                             download("updatemanufacturer", $("#id_manufacturer_selected").val(), $(this).val(), "AdminEGPLOADER", admin_ploader_ajax_url, 0);
                          }).get();
                     });                    
                    ...
                    $("#update_data").click(function() {
                         ...
                         $("td input:checkbox:checked").map(function() {
                             items.push($(this).val());
                          }).get();
